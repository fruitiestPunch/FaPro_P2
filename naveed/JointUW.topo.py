...
class SimpleJointUW(Topo):
    def build(self):
        ...
        self.add_link_name("0", "2", cost=1000, delay=0.2, bw=1000000000000, directed=True)
        self.add_link_name("2", "0", cost=1000, delay=0.2, bw=1000000000000, directed=True)
        ...
        self.add_link_name("2", "3", cost=1000, delay=0.2, bw=1000000000000, directed=True)
        self.add_link_name("3", "2", cost=1000, delay=0.2, bw=1000000000000, directed=True)
