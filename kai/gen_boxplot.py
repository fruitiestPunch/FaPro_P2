...
algo_c_map = {
	...
	'InverseCapacityCloseness' : "royalblue",
	'InverseCapacity' : "cornflowerblue",
...
def box_plot_all_top(df_plot, x_label="Model\n", y_label="\nMax. Normalized Link Utilization", size=(30, 6), title=None, y_lim_top=None):
	...
	#plt.close()
	#print(file_name)
	plt.yticks([0,1],['InverseCapacity','InverseCapacityCloseness'])
	plt.tight_layout()
	plt.grid()
	plt.show()
	return
...
data_joint   = read_csv_data( CSV_FILENAME, "InverseCapacity.topo.sh")
data_weights = read_csv_data( CSV_FILENAME, "InverseCapacityCloseness.topo.sh")
...
print("InverseCapacity Median: ", statistics.median(data_joint))
print("InverseCapacityCloseness Median: ", statistics.median(data_weights))
print("InverseCapacity Minimum: ", min(data_joint))
print("InverseCapacityCloseness Minimum: ", min(data_weights))
print("InverseCapacity Maximum: ", max(data_joint))
print("InverseCapacityCloseness Maximum: ", max(data_weights))
